    ...
    public void moveX(){
        if(xMove > 0){//Moving right
            ...
            if(!collisionWithTile(tx, (int) (y + bounds.y) / Tile.TILEHEIGHT) &&
                ...
                //checking both corners of hitbox rectangle if there is a collision with a solid tile, if not move player.
                x += xMove;

            }else{// there was a collision, set creature coordinate to boundry of tile (- 1 pixel in the end to able to slide down)
